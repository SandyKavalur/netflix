    ...
    it('renders the sign up page with a form submission', async() => {
        ...
        await act(async() =>{
            ...
            await fireEvent.change(getByPlaceholderText('Email address'), {
                target: {value: 'sandykavalur@gmail.com'},
            })
            ...
            expect(getByPlaceholderText('First name').value).toBe('senpai');
            expect(getByPlaceholderText('Email address').value).toBe('sandykavalur@gmail.com');
